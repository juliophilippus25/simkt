...
<head>
    ...
    <title>Peringatan Perpanjangan Masa Sewa</title>
    <style>
        * {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Hai, {{ $userRoom->user->profile->name }}.</h2>
            <p>
                Masa sewa kamar Anda akan berakhir, mohon melakukan pembayaran untuk melanjutkan perpanjangan sewa.
                Informasi lebih lanjut dapat dilihat pada menu
                <b>Penghuni</b>.
            </p>
